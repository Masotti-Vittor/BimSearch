...
public class User extends javax.swing.JFrame {
	...
	// This class is, for sure, the one where we access the database the most. 
	// Here, we do not work with the table images, but with the table bimuser.
	// This class was created so the user, with admin power, can add, modify, search and delete other users. 
	// This table and database should be created when the user run the program (if they have mysql).
	// I must also do it with the table images, or else the user won't be able to save files without a database and a table created manually (database connector_db and table images, with all those columns).



	// These methods are pretty straight.
	public void search(){
